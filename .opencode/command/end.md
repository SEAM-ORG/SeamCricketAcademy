---
description: Session End Protocol — ship GitOps + Project V2 + hygiene
---
...
5. Leave workspace on protected branch; closeout: summary · status · evidence · PR/issue links · board · next step.
